  ...
  return (
    <nav className="w-full text-gray-800 rounded-2xl h-14 p-2 flex justify-between items-center px-8 font-['Inter'] md:w-[80vw] sm:w-[90vw] xss:w-[95vw] mx-auto sm:bg-white/10 sm:backdrop-filter sm:backdrop-blur-3xl sm:shadow-sm">
      ...
      <div className="text-lg flex lg:gap-12 gap-8 sm:flex xss:hidden">
        ...
        <a href="#projects" className="hover:text-green-400 transition-colors duration-200">Projects</a>
        <a href="/blog" className="hover:text-green-400 transition-colors duration-200">Blog</a>
      </div>

      <button className="rounded-full py-2 px-8 text-[#00982a] hover:text-white hover:bg-green-500 transition-all duration-300 text-lg bg-[rgb(0,187,52,0.12)] focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 xs:text-base xs:px-6 xss:text-sm xss:px-5">
        Contact
      </button>
    </nav>
  );
