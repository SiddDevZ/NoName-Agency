                ...
                <div className="w-[50%]">
                  ...
                  <div className="flex items-center space-x-4 mt-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-black">loved by founders worldwide</p>
                    </div>
                  </div>
                </div>
                <div className="w-[50%]">
                  <p className="font-pop text-[1.04rem] tracking-[-0.002em] leading-[1.45rem]">We specialize in designing and developing stunning websites that are optimized to drive conversions. By blending creativity with strategic design, we turn visitors into loyal customers. Our journey began with a simple mission, to deliver high quality development at affordable prices.</p>
                  <button className="px-[1.42rem] mt-5 py-[0.4rem] bg-[#158928] border border-[#158928] transition-all hover:scale-[1.03] hover:bg-[#1e802e] hover:border-[#1e802e] text-white text-base font-pop font-medium rounded-full">Let's Chat</button>
                </div>
              </div>
          </div>
        </main>
